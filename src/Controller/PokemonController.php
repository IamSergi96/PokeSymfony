...
class PokemonController extends AbstractController
{
  ...
  public function insertPokemons(EntityManagerInterface $doctrine)
  {
    ...
    $pokemon->setDescription('Lagartija naranja');
    $pokemon->setImage('https://assets.pokemon.com/assets/cms2/img/pokedex/full/004.png');
    $pokemon->setCodigo(4);

    $pokemon2 = new Pokemon();

    $pokemon2->setNombre('Charmeleon');
    $pokemon2->setDescription('Lagartija algo más grande');
    $pokemon2->setImage('https://assets.pokemon.com/assets/cms2/img/pokedex/full/005.png');
    $pokemon2->setCodigo(5);

    $pokemon3 = new Pokemon();

    $pokemon3->setNombre('Charizard');
    $pokemon3->setDescription('Un dragón todopoderoso... que no es tipo dragon...');
    $pokemon3->setImage('https://assets.pokemon.com/assets/cms2/img/pokedex/full/006.png');
    $pokemon3->setCodigo(6);
    ...
    // El persist es para que doctrine sepa que queremos instertar ese objeto en base de datos
